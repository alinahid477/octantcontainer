...
if "%name%" == "" (
    echo "assuming default name is: merlin-octant"
    set name="merlin-octant"
)
...
set currdir=%cd%
docker run -it --rm -p 51234:51234 -v %currdir%:/root/ --add-host kubernetes:127.0.0.1 --name %name% %name%
PAUSE
